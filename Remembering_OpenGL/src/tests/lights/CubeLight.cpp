...
CubeLight::CubeLight(int wWidth, int wHeight, glm::vec3 pos)
    : m_Width(wWidth), m_Height(wHeight),
    m_Proj(glm::perspective(glm::radians(45.0f), (float)m_Width / (float)m_Height, 0.1f, 100.0f)),
    m_View(glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -3.0f))),
    m_Translation(pos.x, pos.y, pos.z), m_Rotation(0.0f, 1.0f, 0.0f),
    m_Angle(0.0f)
{
    float vertexpositions[] = {
        //x, y, z, tex_u, tex_v, n_x, n_y, n_z
...
CubeLight::CubeLight(int wWidth, int wHeight, glm::vec3 pos, int type)
    : m_Width(wWidth), m_Height(wHeight),
    m_Proj(glm::perspective(glm::radians(45.0f), (float)m_Width / (float)m_Height, 0.1f, 100.0f)),
    m_View(glm::translate(glm::mat4(1.0f), glm::vec3(0.0f, 0.0f, -3.0f))),
    m_Translation(pos.x, pos.y, pos.z), m_Rotation(0.0f, 1.0f, 0.0f),
    m_Angle(0.0f), m_type(type)
{
    float vertexpositions[] = {
        //x, y, z, tex_u, tex_v, n_x, n_y, n_z
        -0.5f, -0.5f, -0.5f,  0.0f,  0.0f, -1.0f,
...
void CubeLight::OnRender(glm::mat4 proj, glm::mat4 view, glm::mat4 model_position)
{
    m_Proj = proj;
    m_View = view;
    ...
    glm::mat4 model = glm::scale(model_position, glm::vec3(0.1f));
...
void CubeLight::OnRender(glm::mat4 proj, glm::mat4 view)
{
    m_Proj = proj;
    m_View = view;
    //GLCall(glClearColor(0.2f, 0.5f, 0.5f, 1.0f));
    ...
    glm::mat4 model_position = glm::translate(glm::mat4(1.0f), m_Translation);
